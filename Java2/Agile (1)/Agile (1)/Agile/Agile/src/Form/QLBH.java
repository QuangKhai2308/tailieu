...
public class QLBH extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cboMaNV.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã NV", "NV001", "NV002" }));
        ...
        cboMaSP.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã SP", "SP001", "SP002" }));
        cboMaSP.setEnabled(false);

        cboTenSP.setEditable(true);
        cboTenSP.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        cboTenSP.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tên SP", "MC Queen", "Vans" }));
        ...
        cboMauSac.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Màu sắc", "Trắng", "Xanh rêu" }));
        ...
        cboSize.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Size", "40", "41" }));
        ...
        btnIn.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        btnIn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/print (2).png"))); // NOI18N
        btnIn.setText("In");
    ...
    private void btnHuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHuyActionPerformed
        // TODO add your handling code here:
        try {
            if (checkNull() && checkSo() && checkSoDT() && checkNgay()) {
    ...
    private boolean checkNull() {
        if (txtMaHD.getText().isEmpty()) {
            ...
            return false;
        } else if (cboMaNV.getSelectedIndex() == 0) {
            ...
            return false;
        } else if (cboTenSP.getSelectedIndex() == 0) {
            ...
            return false;
        } else if (cboMauSac.getSelectedIndex() == 0) {
            ...
            return false;
        } else if (cboSize.getSelectedIndex() == 0) {
...
//            int checkSDT= Integer.parseInt(sdt);
    ...
    private boolean checkNgay() {
        ...
        try {
            date = (Date) sdf.parse(txtNgayBan.getText());
            return true;
        } catch (Exception e) {
